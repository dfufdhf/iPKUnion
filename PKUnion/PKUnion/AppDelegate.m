...
//  PKUnion
//
//  Created by Roy Sun on 14-8-7.
//  Copyright (c) 2014年 PKUnion Team. All rights reserved.
//
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"PKUnion" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"PKUnion.sqlite"];
